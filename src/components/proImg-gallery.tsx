...
export default function ProductImage({
  ...
  return (
    <div className="lg:grid grid-cols-12  gap-2 flex flex-col ">
      <div className="overflow-auto col-span-3 order-last lg:order-first lg:h-[20rem] h-fit no-scrollbar">
        <Swiper
          ...
          {galleryImages?.map((item: any) => (
            ...
            >
              ...
              <Image
                ...
                width={100}
                height={100}
                className="w-16  border rounded-lg cursor-pointer overflow-x-auto"
              />
              </div>
